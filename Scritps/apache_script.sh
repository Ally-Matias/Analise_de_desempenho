...
while true; do
    ...
    # Registra a utilização de CPU dos processos do Apache
    echo "Processos Apache (apenas CPU):" >> "$LOGFILE"
    ps -eo pid,comm,%cpu --sort=-%cpu | grep apache2 | \
